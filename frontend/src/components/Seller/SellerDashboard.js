// Seller Dashboard with Mobile Sidebar
...
export default function SellerDashboard() {
  ...
  return (
    <div className="min-h-full">
              ...
              <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-[#FFB1E1] pt-5 pb-4">
                ...
                <nav className="mt-5 flex flex-1 flex-col divide-y divide-cyan-800 overflow-y-auto" aria-label="Sidebar">
                  <div className="space-y-1 px-2">
                    {[...ordersLinks, ...productsLinks, ...postLinks].map((item) => (
      ...
      {/* Keep your static desktop sidebar and main layout as-is below this */}
      {/* Sidebar and Header */}
      <div className="hidden lg:fixed lg:top-24 lg:bottom-0 lg:flex lg:w-64 lg:flex-col bg-cyan-900 pb-4">
        <nav className="mt-5 pt-4 flex flex-1 flex-col divide-y divide-cyan-800 overflow-y-auto">
          {/* Orders Links */}
