    ...
    icon: () => (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none"
        ...
        <path strokeLinecap="round" strokeLinejoin="round"
          ...
          0-3.182s2.9-.879 4.006 
          0l.415.33M21 12a9 9 0 
    ...
    icon: () => (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none"
        ...
        <path strokeLinecap="round" strokeLinejoin="round"
          ...
          018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 
          6.375 0 0111.964-3.07M12 
          6.375a3.375 3.375 0 11-6.75 
          0 3.375 3.375 0 016.75 0zm8.25 
          2.25a2.625 2.625 0 11-5.25 0 
    ...
    icon: () => (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none"
        ...
        <path strokeLinecap="round" strokeLinejoin="round"
          ...
          4.125S3.75 8.653 3.75 
          6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 
          4.097 3.75 6.375m16.5 
          0v11.25c0 2.278-3.694 4.125-8.25 
          4.125s-8.25-1.847-8.25-4.125V6.375m16.5 
          0v3.75m-16.5-3.75v3.75m16.5 
          0v3.75C20.25 16.153 16.556 18 
          12 18s-8.25-1.847-8.25-4.125v-3.75" />
      </svg>
    ),
  },
  {
...
export default function SellerDashboard() {
  ...
  return (
    <div className="min-h-full">
      {/* Sidebar and Header */}
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col bg-cyan-900 pt-5 pb-4">
        <nav className="mt-5 flex flex-1 flex-col divide-y divide-cyan-800 overflow-y-auto">
          ...
          <div className="mt-1 pt-1 px-2 space-y-1">
            {ordersLinks.map((item) => (
              <Link key={item.name} to={item.href} className="flex items-center text-sm text-cyan-100 px-2 py-2 hover:bg-cyan-600 rounded-md">
        ...
        <main className="flex-1 pb-8">
          <div className="bg-white shadow px-4 sm:px-6 lg:px-8">
            <div className="py-6 flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Welcome, Seller</h1>
