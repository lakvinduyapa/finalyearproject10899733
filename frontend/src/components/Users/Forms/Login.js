              ...
              <div className="lg:max-w-3xl mx-auto py-20 px-4 md:px-10 lg:px-20">
                ...
                <form
                  ...
                  <div className="w-full px-4 flex justify-center">
                   {loading ? (<button className="bg-gray-800 text-white font-bold font-heading py-5 px-8 rounded-md uppercase">
                      Loading...
                    </button>
                    ):( <button className="bg-[#FFB1E1] hover:bg-[#FFB1E1] text-black font-bold font-heading py-5 px-8 rounded-md uppercase">
                      Login
                    </button>)}
                  </div>
                </form>
